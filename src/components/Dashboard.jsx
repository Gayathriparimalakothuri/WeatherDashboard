                    ...
                    <div className='d-flex justify-content-center'>
                        <div className="card  text-start p-4 m-3" style={{ width: '70%' }}>
                            ...
                            <div className="row lh-lg">
                                <div className="col">
                                    🌤<strong className='mx-3'>Temperature: </strong>{weatherData.main.temp} degC
                                </div>
                                <div className="col">
                            ...
                            <div className="row lh-lg">
                                ...
                                <div className="col">
                                    🌡<strong className='mx-3'>Feels Like: </strong>  {weatherData.main.feels_like} degC
                                </div>
                            </div>
                            <div className="row lh-lg">
                                <div className="col">
                                ...
                                <div className="col">
                                    💨<strong className='mx-3'>Wind Speed: </strong>  {weatherData.wind.speed} m/s
                                </div>
                            </div>
                        </div>
                    </div>
